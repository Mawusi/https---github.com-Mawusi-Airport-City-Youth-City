...
use App\Filament\Resources\BSCGResource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\BSCGResource\RelationManagers;
use App\Filament\Resources\BSCGResource\Widgets\BSCGStatsOverview;

class BSCGResource extends Resource
{
    protected static ?string $model = BSCG::class;
    ...
    {
        return [
            'index' => Pages\ListBSCGS::route('/'),
            // 'create' => Pages\CreateBSCG::route('/create'),
            'view' => Pages\ViewBSCG::route('/{record}'),
            'edit' => Pages\EditBSCG::route('/{record}/edit'),
        ];
    }    
}
